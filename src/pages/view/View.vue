<template>
  <div>
    ...
    <div style="text-align:center">
      <el-pagination layout="total,prev,pager,next,jumper" :total="totalFile" :page-size="filePageSize" :hide-on-single-page="hideFileOnSinglePage" @current-change="handleFileCurrentChange"/>
    </div>
  </div>
</template>
